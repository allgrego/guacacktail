...
<section id="two" class="spotlights">
	...
	<section id={{$cocktail['idDrink']}}>
		...
		<div class="content">
			<div class="inner">
				<header class="major">
					<a href="{{'/cocktail/'.$ingredient.'/'.$cocktail['idDrink']}}"><h2>{{$cocktail['strDrink']}}</h2></a>
				</header>
				
				<ul class="actions">
					<li><a href="{{'/cocktail/'.$ingredient.'/'.$cocktail['idDrink']}}" class="button">More Information</a></li>
				</ul>
			</div>
		</div>
	</section>
